...
**registers 28-31, 33-39, 47, 50, 52-54, 56-61** - Unassigned. Not zero in every case - register 48 reads 333 and registers 56-57 read single digits that move between responses - so there is more here to find.
